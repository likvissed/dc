...
ActiveRecord::Schema.define(version: 2020_02_20_015749) do
  ...
  create_table "services", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "value_backup_data"
    t.string "storage_time"
    t.string "store_copies"
    t.string "backup_volume"
    t.string "backup_window"
    t.string "time_recovery"
    t.string "duplicate_ps"
    t.string "raid"
    t.string "bonding"
    t.string "other"
    t.string "resiliency"
    t.string "time_after_failure"
    t.string "disaster_rec"
    t.string "time_after_disaster"
    t.string "antivirus"
    t.string "firewall"
